...
// b1 = 2, k1 = 5, b2 = 4, k2 = 9 -> (-0,5; -0,5)using static System.Console;
...
double intersectionY = k2 * intersectionX + b2;
WriteLine($"Точка пересечения двух прямых : ( {intersectionX} ; {intersectionY} )");
